...
\end{pic}
\end{equation}  
the time-ordering of Alice and Bob's unitaries does not affect the protocol.
In some sense, the connectivity of the diagram means that Alice's unitary happens first in the compositional sequence regardless of the time ordering in the protocol's implementation.
