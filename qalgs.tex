...
The second section applies oPTs to the verification and generalization of quantum blackbox algorithms. We provide a general construction of unitary oracles in arbitrary process theories and prove an equivalence between the unitarity of these oracles and the existence of complementary observables. We then extend work by Vicary~\cite{vicary-tqa} to present a quantum blackbox algorithm for a new problem that identifies group homomorphisms. These results are extensions of collaborative work by the author and Vicary published in~\cite{zeng2014abstract}.
