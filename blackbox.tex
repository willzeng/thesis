...
\end{pic}
\end{equation}
Here we have assumed that we operate in a category where square roots of scalars exist.  In the rest of this section we will suppress drawing circles around scalars. The two algebras are complementary exactly when this composite is unitary, as we show in the following theorem.
...
\caption{Three blackbox quantum algorithms presented as processes in an operational process theory.}
