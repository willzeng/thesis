...
\item In Section~\ref{sec:qalgrel}, a quantum-like process theory in \cat{Rel} is used to build models of the Deutsch-Jozsa, single-shot Grover's, and GROUPHOMID quantum blackbox algorithms in the sets and relations of non-deterministic classical computation. In the case of Grover's algorithm, this leads to a non-trivial classical algorithm.
